...
namespace SpaceShooter.Models.Tests
{
    ...
    public class PlayerListEntryTests : IDisposable
    {
        ...
        public void Equals_Same_True()
        {
            ...
            player1.Save();
            PlayerListEntry leaderboard1 = new PlayerListEntry(player1.Username, 1000);
            PlayerListEntry leaderboard2 = new PlayerListEntry(player1.Username, 1000);
        ...
        public void Equals_NotSame_False()
        {
            ...
            PlayerListEntry leaderboard1 = new PlayerListEntry(player1.Username, 1000);
            PlayerListEntry leaderboard2 = new PlayerListEntry(player2.Username, 23458);
        ...
        public void GetLeaderboard_GetsLeaderboardStats_Stats()
        {
            ...
            PlayerListEntry leaderboard1 = new PlayerListEntry(player1.Username, stats1.Score);
            PlayerListEntry leaderboard2 = new PlayerListEntry(player2.Username, stats2.Score);
        ...
        public void GetSearchResults_GetsSearchResults_Results()
        {
            ...
            Dictionary<string, long> result = PlayerListEntry.GetSearchResults("");
            Dictionary<string, long> test = new Dictionary<string, long> {
                {player2.Username, stats2.Score},
                {player1.Username, stats1.Score}
            };
